// ============================================
// Maxx\'s Lovable – HTML Templates (content)
...
function templateChannelGate(minimized) {
  return '<div id="ql-header">' +
    '<div class="ql-header-left">' +
      ...
      '<img class="ql-title-logo" src="' + chrome.runtime.getURL('assets/logo-master-lovable-square.png') + '" alt=""><span class="ql-title">Maxx\'s Lovable</span>' +
    '</div>' +
  ...
  '<div id="ql-body">' +
    '<div class="ql-license-gate ql-channel-gate">' +
      '<div class="ql-lock-icon" style="font-size: 50px;">✅</div>' +
      '<p class="ql-gate-title">Open Source Build</p>' +
      '<p class="ql-gate-desc">Licensing and channel unlocks are disabled in this build.</p>' +
...
function templateLicenseGate(minimized) {
  ...
  '<div id="ql-body">' +
    '<div class="ql-license-gate">' +
      ...
      '<p class="ql-gate-title">Open Source Build</p>' +
      '<p class="ql-gate-desc">Licensing is disabled in this build.</p>' +
    '</div>' +
  '</div>' +
  '<div id="ql-resize-handle" class="ql-resize-handle"></div>';
}
...
function templateMainUI(greeting, statusBadge, minimized) {
  return '<div id="ql-header">' +
    '<div class="ql-header-left">' +
      '<span class="ql-brand"><img class="ql-brand-logo" src="' + chrome.runtime.getURL('assets/logo-master-lovable-square.png') + '" alt=""><span>Maxx\'s Lovable</span></span>' +
    '</div>' +
    '<div class="ql-header-right">' +
  ...
  '<div id="ql-footer" class="ql-footer">' +
    ...
    '</div>' +
    '<span class="ql-badge-mz">Maxx\'s Lovable</span>' +
  '</div>' +
  '<div id="ql-resize-handle" class="ql-resize-handle"></div>' +
  '<!-- Notifications Panel -->' +
