// ============================================================
// Maxx\'s Lovable - Side Panel Templates (Static/HTML)
...
function spTemplateLicenseGate() {
  return '<div class="sp-license-gate">' +
    ...
    '<p class="sp-gate-title">Open Source Build</p>' +
    '<p class="sp-gate-desc">Licensing is disabled in this build.</p>' +
  '</div>';
}
...
function spTemplateChannelGate() {
  return '<div class="sp-license-gate sp-channel-gate">' +
    ...
    '<p class="sp-gate-desc">Join our WhatsApp channel to get access to all features instantly.</p>' +
    '<button class="sp-btn-primary" id="sp-join-channel-btn" style="background: linear-gradient(135deg, #10b981, #059669); margin-top: 15px; display: flex; align-items: center; justify-content: center; gap: 8px; box-shadow: 0 4px 16px rgba(16, 185, 129, 0.3);">' +
      '👉 Join 🔥 Main Channel & Unlock' +
    '</button>' +
...
function spTemplateStatusBadge(status, support) {
  var url = (support && (support.upgrade_url || support.contact_url || support.whatsapp_url)) ||
            "https://whatsapp.com/channel/0029Vb7jGDG5a245baPA9H3y";
  var safeUrl = spSanitizeUrl(url) || "https://whatsapp.com/channel/0029Vb7jGDG5a245baPA9H3y";
  return '<a href="' + spEscapeHtml(safeUrl) + '" target="_blank" rel="noopener noreferrer" ' +
         'class="sp-status-badge sp-badge-pro sp-badge-upgrade" title="Upgrade your plan" ' +
         'style="text-decoration:none;cursor:pointer">⚡ Upgrade</a>';
}
